describe('create courses', function() {
    ...
    it('create new course', function(){
      ...
      initialCount = rows.length;
        ...
        //cy.get('.table.courses-table.table.table-borderless tbody > tr').last().click();
        //cy.xpath("//table[@class='courses-table table table-borderless']//button").last().click();
        //cy.get('table.courses-table.table.table-borderless tbody > tr button').last().click();
